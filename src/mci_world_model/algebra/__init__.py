"""mci_world_model.algebra — pure mathematical object layer.

This package contains the linear-algebra / probability-graph primitives that
underlie mci-world-model's structured multi-dimensional coordinate system.

Design contract (inherited from su-memory-sdk, verbatim):
