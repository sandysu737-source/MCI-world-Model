...
Usage:
    >>> from mci_world_model.world_model import YinYang, FourSymbols
    >>> from mci_world_model.world_model import TemporalCore

    >>> tc = TemporalCore()
    >>> code = tc.encode(year=2024, month=6, day=15)
    >>> print(code.cycle_name)  # '甲午'

    >>> from mci_world_model.world_model import UnifiedInfoFactory
...
# 检索融合
# ═══════════════════════════════════════════
from mci_world_model._sys import MultiViewRetriever
