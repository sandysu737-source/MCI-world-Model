...
class CausalChain:
    ...
    def add(self, memory_id: str, category: str | None = None, energy_type: str | None = None) -> None:
    ...
    def link_with_category(
        self, parent: str, child: str, parent_category: str | None = None, child_category: str | None = None
    ) -> bool:
    ...
    def link_with_energy(
        self, parent: str, child: str, parent_energy: str | None = None, child_energy: str | None = None
    ) -> bool:
    ...
    def link_with_timecode(
        self, parent: str, child: str, parent_tb: str | None = None, child_tb: str | None = None
    ) -> bool:
