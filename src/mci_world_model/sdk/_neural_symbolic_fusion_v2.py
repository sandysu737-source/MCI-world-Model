...
class NeuralSymbolicFusionV2:
    ...
    def neural_to_symbolic(self, neural_repr: np.ndarray, var_names: list[str] | None = None) -> list[dict[str, Any]]:
        """从神经表征提取符号规则。
    ...
    def symbolic_to_neural(self, rules: list[dict[str, Any]], target_dim: int) -> np.ndarray:
        """从符号规则约束神经表征。
